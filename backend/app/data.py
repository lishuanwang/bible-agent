...
Production should replace this with PostgreSQL + pgvector + licensed datasets.
"""
...
VERSE_DATA = {
    "CUV": {
        ...
        "James 1:5": "你们中间若有缺少智慧的，应当求那厚赐与众人、也不斥责人的神，主就必赐给他。",
    },
    "NIV": {
...
TOPIC_MAP = {
    ...
    "祷告": ["Philippians 4:6", "James 1:5"],
    "智慧": ["James 1:5", "Romans 8:28"],
    "婚姻": ["Philippians 4:6", "Psalm 23:1"],
    "职场": ["James 1:5", "Romans 8:28"],
}
